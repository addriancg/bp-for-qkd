...
Matrices getchecknodetable(double rate)
{
	...
	if(rate == 1.0 / 2.0){
		...
		int ct1_rows = 5, ct1_cols = 12;
		int ct2_rows = 10, ct2_cols = 3;
	...
	}else if (rate == 2.0 / 5.0){

		int ct1_rows = 6, ct1_cols = 12;
		int ct2_rows = 12, ct2_cols = 3;
	...
	}else if (rate == 3.0 / 5.0){

		int ct1_rows = 9, ct1_cols = 12;
		int ct2_rows = 18, ct2_cols = 3;
		...
		int ct1_rows = 3, ct1_cols = 13;
		int ct2_rows = 27, ct2_cols = 3;
	...
	}else if (rate == 3.0 / 4.0){

		int ct1_rows = 1, ct1_cols = 12;
		int ct2_rows = 32, ct2_cols = 3;
		...
		int ct1_rows = 1, ct1_cols = 13;
		int ct2_rows = 36, ct2_cols = 3;
	...
	}else if (rate == 8.0 / 9.0){

		int ct1_rows = 5, ct1_cols = 4;
		int ct2_rows = 35, ct2_cols = 3;
